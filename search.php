<?php 
	...
	// $sql_pro="select product.id, product.avatar, product.name,product.price,product.Khuyen_mai,product.quantity_pro from product limit $so_trang,5";
				...
				<div class=" block_content col-xs-12  col-md-9 col-lg-9">
					...
					<div class="show-pro">
						...
						<?php }else{ ?>
							<?php 
								$trang=ceil($count/5);
								while ($result_search=mysqli_fetch_array($query_search)) {
							?>
							<div class="pro col-xs-12 col-sm-6 col-md-4 col-lg-4 text-center">
								<div class="border-product">
									<a href="detail-product.php?id=<?php echo $result_search['id'] ?>" class="thumbnail">
										<img src="public/image/<?php echo $result_search['avatar'] ?>" alt="" width="100%">
									</a>
									<a href="detail-product.php?id=<?php echo $result_search['id'] ?>"><?php echo $result_search['name'] ?></a>
									<?php if ($result_search['Khuyen_mai']>0) { ?>
										<p>Giá: <span style="color:#333;"><s><?php echo number_format($result_search['price'],0) ?> VNĐ</s></span></p>
										<p>Khuyến mãi: <span style="color: red"><?php echo number_format($result_search['Khuyen_mai'],0) ?> VNĐ</span></p>
									<?php }else{ ?>
										<p>Giá: <span style="color:#333;"><?php echo number_format($result_search['price'],0) ?> VNĐ</span></p>
									<?php } ?>
									<?php 
									if ($result_search['quantity_pro']>0) {
									?>
									...
									<?php } ?>
									<p>
										<a href="detail-product.php?id=<?php echo $result_search['id'] ?>" class="btn btn-success btn-sm">
											<span>Xem</span>
										</a>
										<a href="cart.php?id=<?php echo $result_search['id'] ?>" class="btn btn-danger btn-sm">

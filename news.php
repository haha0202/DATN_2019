<?php 
	...
	$sql="select * from news limit $so_trang,5";
			...
			<div class="row">
				...
				<div class=" block_content col-xs-12  col-md-9 col-lg-9">
					...
					<div class="content">
						...
						?>
						<div class="media">
							<a class="pull-left" href="detail-new.php?id=<?php echo $rs['id'] ?>">
							
								<img class="media-object" src="backend/quanlytintuc/upload/<?php echo $rs['image'] ?>" alt="Image" width="180">
							</a>

							<div class="media-body">
								<h4 class="media-heading"><a href="detail-new.php?id=<?php echo $rs['id'] ?>"><?php echo $rs['name'] ?></a></h4>
								<p>
									<?php echo strip_tags(substr($rs['content'], 0,320))."..."; ?>
								</p>
							</div>
						</div>
						<?php } ?>

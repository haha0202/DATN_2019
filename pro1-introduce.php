...
<head>
	...
	<link rel="stylesheet" href="public/css/pro1-introduce.css">	
</head>
<body>
	<div class="container">
		<header class="header">
			...
			<div class="row">
				...
				<div class=" block_content col-xs-12  col-md-9 col-lg-9">
					<h1 class="title_index">
						<span>Hoạt huyết >> <span>Giới thiệu</span></span>
					</h1>
					<div class="content">
						<div class="detail">
							<div>
								<p>
								Với kinh nghiệm hơn 20 năm điều trị lâm sàng tại bệnh viện chuyên khoa Y học Cổ Truyền đầu ngành tại Việt nam, chúng tôi đã nghiên cứu và bào chế ra thuốc viên “Hoạt huyết” Gia Bảo.</p>

								<p>Thuốc được bào chế từ những vị thuốc, thảo dược thiên nhiên đã được sử dụng trong suốt hàng ngàn năm y học cổ truyền. Thuốc “Hoạt huyết Gia Bảo” không sử dụng bất kỳ một loại chất bảo quản nào trong quá trình sản xuất và tuyệt đối thân thiện với cơ thể con người.</p>

								<p>Thành phần: Xuyên khung, Quy vĩ, Đan sâm, Chỉ xác, Hòe hoa, Cam thảo...</p>		
							</div>
						</div>
						<div class="comment">
							<div id="fb-root"></div>

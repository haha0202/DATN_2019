...
<body>
	...
	<nav class="navbar navbar-inverse">
		...
		<?php 
			if (isset($_GET['id'])) {
				$id=$_GET['id'];
				$sql="SELECT product_image.id, product.name as product_name, product_image.hinh_anh from product_image join product on product_image.pro_id=product.id where product_image.id=$id";

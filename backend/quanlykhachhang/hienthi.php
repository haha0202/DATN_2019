...
<body>
	...
	<div class="main-right col-xs-10 col-sm-10 col-md-10 col-lg-10">
		<?php 
			...
			include('../connect.php');
			$qr = mysqli_query($conn,"select * from customer") or die('Lỗi truy vấn');
				...
				<div class="header">
					...
					<div class="col-xs-6 col-sm-6 col-md-6 col-lg-6 text-right">
						<form action="" method="POST" class="form-inline" role="form">
							...
							<a href="insert.php" class="btn btn-info">Thêm khách hàng</a>
						</form>
					</div>
				</div>
					...
					<tbody> 
						...
						?>
							<tr>
								...
								<td>
									<a href="update.php?id=<?= $result['id'] ?>" class="btn btn-warning btn-xs">Sửa</a>
									<a href="delete.php?id=<?= $result['id'] ?>" class="btn btn-danger btn-xs" onclick="return confirm('Bạn có chắc muốn xóa không?')">Xóa</a>

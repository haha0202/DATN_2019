...
<body>
	...
	<nav class="navbar navbar-inverse">
		...
		<div class="main-right col-xs-10 col-sm-10 col-md-10 col-lg-10">
			<div class="panel panel-primary">
				<div class="panel-heading">
					<h3 class="panel-title">Quản lý kiến thức</h3>
				</div>
				...
				<div class="header">
					...
					<div class="col-xs-6 col-sm-6 col-md-6 col-lg-6 text-right">
						<form action="" method="POST" class="form-inline" role="form">
							...
							<a href="insert.php" class="btn btn-info">Thêm kiến thức</a>
						</form>
					</div>
				</div>
				<table class="table table-hover">
					...
					?>
						<tr>
							...
							<td><img src="upload/<?php echo $result['image'] ?>" width="80" height="80" alt=""></td>
							<td><?php echo $result['knowledge_date'] ?></td>
							<td>
								...
								<a href="detail.php?id=<?php echo $result['id'] ?>" class="btn btn-primary">Xem</a>			
							</td>
						</tr>
					<?php $a++;} ?>	
					</tbody>

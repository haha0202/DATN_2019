<?php 
	...
	$sql_know="select * from knowledge where id = '$id'";
	$query_know=mysqli_query($conn,$sql_know);
	$result_know=mysqli_fetch_array($query_know);
...
<head>
	...
	<link rel="stylesheet" href="public/css/detail-knowledge.css">
			...
			<div class="row">
				...
				<div class=" block_content col-xs-12  col-md-9 col-lg-9">
					<h1 class="title_index">
						<span><?php echo $result_know['name'] ?></span>
					</h1>
					<div class="content">
						<div class="detail">
							<div>
								<?php echo $result_know['content']; ?>
							</div>
						</div>
						<div class="comment">
							<div id="fb-root"></div>
						...
						<div class="panel panel-info">
							...
							<div class="list-group">
								<a href="#" class="list-group-item"><span class="glyphicon glyphicon-file"></span> KIến thức cơ bản về Dược phẩm Gia Bảo</a>
								<a href="#" class="list-group-item"><span class="glyphicon glyphicon-file"></span >Điều trị ung thư bằng Nấm Linh Chi đỏ</a>
								<a href="#" class="list-group-item"><span class="glyphicon glyphicon-file"></span> Tác dụng của cây húng chanh</a>
								<a href="#" class="list-group-item"><span class="glyphicon glyphicon-file"></span> Ngải cứu - Cây thuốc vườn nhà</a>
								<a href="#" class="list-group-item"><span class="glyphicon glyphicon-file"></span> Công nghệ Nano Curcumin</a>
								<a href="#" class="list-group-item"><span class="glyphicon glyphicon-file"></span> Tác dụng thần kì của bột nghệ vàng</a>
								<a href="#" class="list-group-item"><span class="glyphicon glyphicon-file"></span> Công dụng tuyệt vời của Nano Curcumin</a>
							</div>
						</div>
					</div>
